...
async def select_in_cont2uz_sub1(message: types.Message, state: FSMContext):
    ...
    if message.text == "Назад":
        ...
        for id, category, sub1_code, sub1category, sub1category_uz, sub2category, sub2category_uz, article_url, article_url_uz, like, dislike, viewed in await db.select_in_sub1category(category=categ, sub1category=sub1):
            await db.update_flat(id=id, sub1category=new_sub1)
        for id, category, sub1_code, sub1category, sub1category_uz, sub2category, sub2category_uz, article_url, article_url_uz, like, dislike, viewed in await db.select_in_sub1category_uz(category=categ, sub1category_uz=sub1_uz):
...
async def select_in_cont2uz_sub2(message: types.Message, state: FSMContext):
    ...
    if message.text == "Назад":
        ...
        for id, category, sub1_code, sub1category, sub1category_uz, sub2category, sub2category_uz, article_url, article_url_uz, like, dislike, viewed in await db.select_in_sub2category(category=categ,
                                                                                                                        sub1category=sub1,
                                                                                                                        sub2category=sub2):
            await db.update_flat(id=id, sub2category=new_sub2)
        for id, category, sub1_code, sub1category, sub1category_uz, sub2category, sub2category_uz, article_url, article_url_uz, like, dislike, viewed in await db.select_in_sub2category_uz(category=categ,
